...
## Build STAR examples from the profile

Draft STAR answers from `profile/candidate.md` for the current interview. Arrange confirmed facts into Situation, Task, Action, and Result without adding scope, metrics, or outcomes. Ask the user for missing context before treating an incomplete story as ready.
