...
**Every claim in a form field must be defensible from `profile/candidate.md`.** The interviewer reads the form alongside the CV. A form field is not a place to introduce new claims, inflate scope, or fill space. Select from what is already true and arrange it for the question asked.
...
- [ ] Every factual claim traces to `profile/candidate.md`
