# Europe visa sponsors URL reference
...
Returns the job with `content` as HTML.
...
| BlaBlaCar | Lever | `blablacar` |
| Delivery Hero | SmartRecruiters | `deliveryhero` |
| Trustpilot | SmartRecruiters | `trustpilot` |
| Glovo | SmartRecruiters | `glovo` |
| OVHcloud | SmartRecruiters | `ovhcloud` |
| Zalando | SmartRecruiters | `zalando` |
| Unbabel | SmartRecruiters | `unbabel` |

Companies from the source sheet with no public careers API are not in this
